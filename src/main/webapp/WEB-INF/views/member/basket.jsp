...
<div style="border-top: 0px solid #000000; padding:15px 0;" align="center" >	
	...
	<c:forEach var="b" items="${b_list}">
		...
		<c:if test="${not empty b_list }">
			<tr height="30px">
               <td colspan="10" align="right"><div><b> 총 상품금액 :</b> <input type="text" id="sum" size="8px" value=0 style="border:0 solid black; font-size:20px; font-weight:bold;color:#d54040; text-align: center;" readonly/> </div></td>
			</tr>	
			<tr height="80px">
